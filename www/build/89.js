...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__player__ = __webpack_require__(2213);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_utils_url__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_utils_utils__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__app_app_component__ = __webpack_require__(1018);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__providers_lesson__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__providers_lesson_offline__ = __webpack_require__(239);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__providers_lesson_sync__ = __webpack_require__(240);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__providers_helper__ = __webpack_require__(1017);
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
var AddonModLessonPlayerPage = /** @class */ (function () {
     ...
     */
    AddonModLessonPlayerPage.prototype.callFunction = function (func, args, options) {
        var _this = this;
        return func.apply(func, args).catch(function (error) {
            if (!_this.offline && !_this.review && _this.lessonProvider.isLessonOffline(_this.lesson) &&
                ...
                return _this.lessonProvider.getPagesPossibleJumps(_this.lesson.id, {
                    cmId: _this.lesson.coursemodule,
                    readingStrategy: 1 /* PreferCache */,
                }).then(function (jumpList) {
                    _this.jumps = jumpList;
                    // Call the function again with offline mode and the new jumps.
                    options.readingStrategy = 1 /* PreferCache */;
                    options.jumps = _this.jumps;
    ...
    AddonModLessonPlayerPage.prototype.fetchLessonData = function () {
        ...
        return this.lessonSync.waitForSync(this.lessonId).then(function () {
            ...
            var options = {
                cmId: _this.lesson.coursemodule,
                readingStrategy: _this.offline ? 1 /* PreferCache */ : 2 /* OnlyNetwork */,
            };
            return _this.callFunction(_this.lessonProvider.getAccessInformation.bind(_this.lessonProvider), [_this.lesson.id, options], options);
        }).then(function (info) {
            var promises = [];
            ...
            if (_this.password) {
                ...
                promises.push(_this.callFunction(_this.lessonProvider.getLessonWithPassword.bind(_this.lessonProvider), [_this.lesson.id, options], options).then(function (lesson) {
                    _this.lesson = lesson;
                }));
            }
            if (_this.offline) {
                // Offline mode, get the list of possible jumps to allow navigation.
                promises.push(_this.lessonProvider.getPagesPossibleJumps(_this.lesson.id, {
                    cmId: _this.lesson.coursemodule,
                    readingStrategy: 1 /* PreferCache */,
                }).then(function (jumpList) {
                    _this.jumps = jumpList;
    ...
    AddonModLessonPlayerPage.prototype.finishRetake = function (outOfTime) {
        ...
        if (this.offline && this.appProvider.isOnline()) {
            ...
            promise = this.lessonSync.syncLesson(this.lesson.id, true, true).then(function (result) {
                if (result.warnings && result.warnings.length) {
                    ...
                    return _this.lessonProvider.getAccessInformation(_this.lesson.id, {
                        cmId: _this.lesson.coursemodule,
                    }).then(function (info) {
        ...
        return promise.then(function () {
            ...
            var args = [_this.lesson, _this.courseId, options];
            return _this.callFunction(_this.lessonProvider.finishRetake.bind(_this.lessonProvider), args, options);
        }).then(function (data) {
    ...
    AddonModLessonPlayerPage.prototype.launchRetake = function (pageId) {
        ...
        return promise.then(function (data) {
            ...
            if (_this.lesson.timelimit && !_this.accessInfo.canmanage) {
                ...
                return _this.lessonProvider.getTimers(_this.lesson.id, {
                    cmId: _this.lesson.coursemodule,
                    readingStrategy: 2 /* OnlyNetwork */,
    ...
    AddonModLessonPlayerPage.prototype.loadMenu = function () {
        ...
        var options = {
            ...
            readingStrategy: this.offline ? 1 /* PreferCache */ : 2 /* OnlyNetwork */,
        };
        var args = [this.lessonId, options];
        return this.callFunction(this.lessonProvider.getPages.bind(this.lessonProvider), args, options).then(function (pages) {
    ...
    AddonModLessonPlayerPage.prototype.loadPage = function (pageId) {
        ...
        var args = [this.lesson, pageId, options];
        return this.callFunction(this.lessonProvider.getPageData.bind(this.lessonProvider), args, options).then(function (data) {
    ...
    AddonModLessonPlayerPage.prototype.processPage = function (data, formSubmitted) {
        ...
        var args = [this.lesson, this.courseId, this.pageData, data, options];
        return this.callFunction(this.lessonProvider.processPage.bind(this.lessonProvider), args, options).then(function (result) {
            if (formSubmitted) {
            ...
            if (!_this.offline && !_this.review && _this.lessonProvider.isLessonOffline(_this.lesson)) {
                ...
                if (_this.lessonProvider.isQuestionPage(_this.pageData.page.type)) {
                    _this.lessonProvider.getQuestionsAttemptsOnline(_this.lessonId, retake, options_1);
                }
                else {
                    _this.lessonProvider.getContentPagesViewedOnline(_this.lessonId, retake, options_1);
                }
            }
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_10" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["f" /* Content */]),
