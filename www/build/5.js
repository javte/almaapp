...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_components_module__ = __webpack_require__(436);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__submission__ = __webpack_require__(2238);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__core_grades_providers_helper__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_assessment_strategy_assessment_strategy__ = __webpack_require__(1049);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__providers_workshop__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__providers_helper__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__providers_offline__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__providers_sync__ = __webpack_require__(234);
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
var AddonModWorkshopSubmissionPage = /** @class */ (function () {
    ...
    AddonModWorkshopSubmissionPage.prototype.fetchSubmissionData = function () {
        ...
        return this.workshopHelper.getSubmissionById(this.workshopId, this.submissionId, {
            ...
            if (_this.access.canviewallassessments) {
                ...
                // Get new data, different that came from stateParams.
                promises.push(_this.workshopProvider.getAssessment(_this.workshopId, _this.assessmentId, {
                    cmId: _this.module.id,
                ...
                _this.workshopProvider.getSubmissionAssessments(_this.workshopId, _this.submissionId, {
                    cmId: _this.module.id,
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_10" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_12__components_assessment_strategy_assessment_strategy__["a" /* AddonModWorkshopAssessmentStrategyComponent */]),
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_10" /* ViewChild */])('feedbackFormEl'),
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(2239)(module)))
