...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__form__ = __webpack_require__(2191);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_sync__ = __webpack_require__(238);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__core_login_providers_helper__ = __webpack_require__(88);
...
var AddonModFeedbackFormPage = /** @class */ (function () {
        ...
        return this.feedbackProvider.getFeedback(this.courseId, this.module.id).then(function (feedbackData) {
            ...
            if (!_this.preview && accessData.cansubmit && !accessData.isempty) {
                return typeof _this.currentPage == 'undefined' ?
                    _this.feedbackProvider.getResumePage(_this.feedback.id, options) : Promise.resolve(_this.currentPage);
            }
            else {
                _this.preview = true;
            ...
            if (!_this.offline && !_this.utils.isWebServiceError(error)) {
                ...
                return _this.feedbackProvider.getResumePage(_this.feedback.id, options);
            }
    ...
    AddonModFeedbackFormPage.prototype.fetchAccessData = function () {
        ...
        return this.feedbackProvider.getFeedbackAccessInformation(this.feedback.id, options).catch(function (error) {
            if (!_this.offline && !_this.utils.isWebServiceError(error)) {
                // If it fails, go offline.
                _this.offline = true;
                options.readingStrategy = 1 /* PreferCache */;
                return _this.feedbackProvider.getFeedbackAccessInformation(_this.feedback.id, options);
            }
            return Promise.reject(error);
        }).then(function (accessData) {
    ...
    AddonModFeedbackFormPage.prototype.fetchFeedbackPageData = function (page) {
        ...
        if (this.preview) {
            ...
            promise = this.feedbackProvider.getPageItemsWithValues(this.feedback.id, page, options).catch(function (error) {
                if (!_this.offline && !_this.utils.isWebServiceError(error)) {
                    // If it fails, go offline.
                    _this.offline = true;
                    options.readingStrategy = 1 /* PreferCache */;
                    return _this.feedbackProvider.getPageItemsWithValues(_this.feedback.id, page, options);
                }
                return Promise.reject(error);
    ...
    AddonModFeedbackFormPage.prototype.gotoPage = function (goPrevious) {
        ...
        return this.feedbackSync.syncFeedback(this.feedback.id).catch(function () {
            ...
            return _this.feedbackProvider.processPage(_this.feedback.id, _this.currentPage, responses, {
    ...
    AddonModFeedbackFormPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* NavParams */], __WEBPACK_IMPORTED_MODULE_4__providers_feedback__["a" /* AddonModFeedbackProvider */], __WEBPACK_IMPORTED_MODULE_9__providers_app__["b" /* CoreAppProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["c" /* TranslateService */], __WEBPACK_IMPORTED_MODULE_13__core_login_providers_helper__["b" /* CoreLoginHelperProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* Content */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["N" /* NgZone */], __WEBPACK_IMPORTED_MODULE_12__core_course_providers_helper__["b" /* CoreCourseHelperProvider */]])
