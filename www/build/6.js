...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__player__ = __webpack_require__(2227);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__classes_data_model_12__ = __webpack_require__(2228);
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
var AddonModScormPlayerPage = /** @class */ (function () {
    ...
    AddonModScormPlayerPage.prototype.determineAttemptAndMode = function (attemptsData) {
        ...
        return this.scormHelper.determineAttemptToContinue(this.scorm, attemptsData).then(function (data) {
            ...
            if (_this.attempt > 0) {
                return _this.scormProvider.isAttemptIncomplete(_this.scorm.id, _this.attempt, {
                    offline: _this.offline,
                    cmId: _this.scorm.coursemodule,
                });
            }
            else {
            ...
            if (result.attempt > _this.attempt) {
                ...
                if (_this.offline) {
                    ...
                    return _this.scormProvider.getScormUserData(_this.scorm.id, result.attempt, {
                        cmId: _this.scorm.coursemodule,
    ...
    AddonModScormPlayerPage.prototype.fetchData = function () {
        ...
        return this.scormSyncProvider.waitForSync(this.scorm.id).then(function () {
            // Get attempts data.
            return _this.scormProvider.getAttemptCount(_this.scorm.id, { cmId: _this.scorm.coursemodule }).then(function (attemptsData) {
                return _this.determineAttemptAndMode(attemptsData).then(function () {
                    // Fetch TOC and get user data.
                    var promises = [];
                    promises.push(_this.fetchToc());
                    promises.push(_this.scormProvider.getScormUserData(_this.scorm.id, _this.attempt, {
                        cmId: _this.scorm.coursemodule,
                        offline: _this.offline,
                    }).then(function (data) {
                        _this.userData = data;
                    ...
                    promises.push(_this.scormProvider.getAccessInformation(_this.scorm.id, {
                        cmId: _this.scorm.coursemodule,
    ...
    AddonModScormPlayerPage.prototype.fetchToc = function () {
        ...
        return this.scormProvider.isAttemptIncomplete(this.scorm.id, this.attempt, {
            ...
            // Get TOC.
            return _this.scormProvider.getOrganizationToc(_this.scorm.id, _this.attempt, {
                organization: _this.organizationId,
                offline: _this.offline,
                cmId: _this.scorm.coursemodule,
            });
        }).then(function (toc) {
            ...
            if (!_this.currentSco) {
                ...
                if (!_this.currentSco) {
                    ...
                    return _this.scormHelper.getFirstSco(_this.scorm.id, _this.attempt, {
                        toc: _this.toc,
                        organization: _this.organizationId,
                        mode: _this.mode,
                        offline: _this.offline,
    ...
    AddonModScormPlayerPage.prototype.loadSco = function (sco) {
        ...
        if (sco.scormtype == 'asset') {
            ...
            this.scormProvider.saveTracks(sco.id, this.attempt, tracks_1, this.scorm, this.offline).catch(function () {
                ...
                if (!_this.offline) {
                    return _this.scormProvider.getScormUserData(_this.scorm.id, _this.attempt, {
                        cmId: _this.scorm.coursemodule,
                    }).then(function (data) {
    ...
    AddonModScormPlayerPage.prototype.setStartTime = function (scoId) {
        ...
        return this.scormProvider.saveTracks(scoId, this.attempt, tracks, this.scorm, this.offline).then(function () {
            if (!_this.offline) {
                ...
                _this.scormProvider.getAttemptCount(_this.scorm.id, {
                    cmId: _this.scorm.coursemodule,
                    readingStrategy: 2 /* OnlyNetwork */,
                }).catch(function () {
                    // Ignore errors.
