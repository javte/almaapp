...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__attempt__ = __webpack_require__(2217);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_quiz__ = __webpack_require__(109);
...
var AddonModQuizAttemptPage = /** @class */ (function () {
    ...
    AddonModQuizAttemptPage.prototype.fetchAttempt = function () {
        ...
        promises.push(this.quizProvider.getUserAttempts(this.quizId, { cmId: this.quiz.coursemodule }).then(function (attempts) {
        ...
        promises.push(this.quizProvider.getCombinedReviewOptions(this.quiz.id, { cmId: this.quiz.coursemodule }).then(function (opts) {
            options = opts;
        }));
        ...
        promises.push(this.quizProvider.getQuizAccessInformation(this.quiz.id, { cmId: this.quiz.coursemodule })
            ...
            if (accessInfo.canreviewmyattempts) {
                ...
                return _this.quizProvider.invalidateAttemptReviewForPage(_this.attemptId, -1).catch(function () {
                    ...
                    return _this.quizProvider.getAttemptReview(_this.attemptId, { page: -1, cmId: _this.quiz.coursemodule });
                }).catch(function () {
        ...
        return Promise.all(promises).then(function () {
            ...
            if (_this.quiz.showFeedbackColumn && _this.quizProvider.isAttemptFinished(_this.attempt.state) &&
                ...
                return _this.quizProvider.getFeedbackForGrade(_this.quiz.id, grade, {
