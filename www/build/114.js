...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__core_rating_components_components_module__ = __webpack_require__(1016);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_components_module__ = __webpack_require__(430);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__entry__ = __webpack_require__(2188);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_sync__ = __webpack_require__(244);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_fields_delegate__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_components_module__ = __webpack_require__(430);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__core_comments_providers_comments__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__core_comments_components_comments_comments__ = __webpack_require__(439);
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
var AddonModDataEntryPage = /** @class */ (function () {
    ...
    AddonModDataEntryPage.prototype.fetchEntryData = function (refresh, isPtr) {
        ...
        return this.dataProvider.getDatabase(this.courseId, this.module.id).then(function (data) {
            ...
            _this.data = data;
            return _this.dataProvider.getFields(_this.data.id, { cmId: _this.module.id }).then(function (fieldsData) {
            ...
            return _this.setEntryFromOffset().then(function () {
                return _this.dataProvider.getDatabaseAccessInformation(_this.data.id, { cmId: _this.module.id });
            });
    ...
    AddonModDataEntryPage.prototype.setEntryFromOffset = function () {
        ...
        return this.dataHelper.fetchEntries(this.data, this.fieldsArray, {
            ...
            if (pageIndex + 1 < pageEntries.length) {
                ...
                promise = _this.dataProvider.getEntries(_this.data.id, {
                    groupId: _this.selectedGroup,
                    page: page + 1,
                    perPage: perPage,
                }).then(function (entries) {
            ...
            return Promise.resolve(promise).then(function () {
                if (_this.entryId > 0) {
                    ...
                    return _this.dataProvider.getEntry(_this.data.id, _this.entryId, { cmId: _this.module.id }).then(function (entry) {
                        _this.ratingInfo = entry.ratinginfo;
                    });
                }
            });
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_10" /* ViewChild */])(__WEBPACK_IMPORTED_MODULE_14__core_comments_components_comments_comments__["a" /* CoreCommentsCommentsComponent */]),
    ...
    AddonModDataEntryPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["t" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_utils_utils__["b" /* CoreUtilsProvider */], __WEBPACK_IMPORTED_MODULE_5__providers_groups__["a" /* CoreGroupsProvider */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_sites__["b" /* CoreSitesProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["s" /* NavController */], __WEBPACK_IMPORTED_MODULE_6__providers_events__["b" /* CoreEventsProvider */],
