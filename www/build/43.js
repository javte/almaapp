...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__credentials__ = __webpack_require__(2272);
...
var CoreLoginCredentialsPage = /** @class */ (function () {
    ...
    CoreLoginCredentialsPage.prototype.showInstructionsAndScanQR = function () {
        ...
        this.domUtils.showAlertWithOptions({
            ...
            message: this.translate.instant('core.login.faqwhereisqrcodeanswer', { $image: __WEBPACK_IMPORTED_MODULE_9__providers_helper__["b" /* CoreLoginHelperProvider */].FAQ_QRCODE_IMAGE_HTML }),
            buttons: [
                {
