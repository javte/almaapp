...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__player__ = __webpack_require__(2220);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__core_question_providers_helper__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__core_question_components_question_question__ = __webpack_require__(1034);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__app_app_component__ = __webpack_require__(1018);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_quiz__ = __webpack_require__(109);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__classes_auto_save__ = __webpack_require__(2221);
// (C) Copyright 2015 Moodle Pty Ltd.
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
var AddonModQuizPlayerPage = /** @class */ (function () {
    ...
    AddonModQuizPlayerPage.prototype.fetchData = function () {
        ...
        return this.quizSync.waitForSync(this.quizId).then(function () {
            ...
            return _this.quizProvider.getQuizAccessInformation(_this.quiz.id, {
            ...
            return _this.quizProvider.getUserAttempts(_this.quiz.id, {
                cmId: _this.quiz.coursemodule,
                readingStrategy: _this.offline ? 1 /* PreferCache */ : 2 /* OnlyNetwork */,
            });
    ...
    AddonModQuizPlayerPage.prototype.prepareAnswers = function () {
        return this.questionHelper.prepareAnswers(this.questions, this.getAnswers(), this.offline, this.component, this.quiz.coursemodule);
    };
    /**
     * Process attempt.
     *
    ...
    AddonModQuizPlayerPage.prototype.processAttempt = function (userFinish, timeUp, retrying) {
        ...
        return promise.then(function (answers) {
            ...
            return _this.questionHelper.clearTmpData(_this.questions, _this.component, _this.quiz.coursemodule);
        });
    };
    /**
    ...
    AddonModQuizPlayerPage.prototype.startOrContinueAttempt = function () {
        ...
        return this.quizHelper.getAndCheckPreflightData(this.quiz, this.quizAccessInfo, this.preflightData, attempt, this.offline, false, 'addon.mod_quiz.startattempt').then(function (attempt) {
            ...
            return _this.quizProvider.getAttemptAccessInformation(_this.quiz.id, attempt.id, {
                cmId: _this.quiz.coursemodule,
                readingStrategy: _this.offline ? 1 /* PreferCache */ : 2 /* OnlyNetwork */,
            }).then(function (info) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_11" /* ViewChildren */])(__WEBPACK_IMPORTED_MODULE_10__core_question_components_question_question__["a" /* CoreQuestionComponent */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_connection_error_connection_error__ = __webpack_require__(1043);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs__ = __webpack_require__(83);
